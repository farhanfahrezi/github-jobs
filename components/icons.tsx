...
export const GoogleLogoIcon: React.FC<IconSvgProps> = (props) => {
  ...
  return (
    ...
    >
      <path
        d="M30.57 24.318v11.038h15.378c-.676 3.55-2.702 6.555-5.74 8.576l9.272 7.177C54.883 46.134 58 38.828 58 30.149c0-2.022-.182-3.965-.52-5.83H30.57z"
        fill="#4285F4"
      />
      <path
        d="M14.559 34.925l-2.092 1.597-7.402 5.752C9.765 51.573 19.4 58 30.57 58c7.715 0 14.182-2.539 18.91-6.891l-9.273-7.177c-2.546 1.71-5.793 2.746-9.637 2.746-7.428 0-13.74-5-16-11.737l-.011-.016z"
        fill="#34A853"
      />
      <path
        d="M5.065 16.727A28.091 28.091 0 002 29.5c0 4.612 1.117 8.939 3.065 12.773 0 .026 9.506-7.358 9.506-7.358-.571-1.71-.909-3.523-.909-5.415s.338-3.705.91-5.415l-9.507-7.358z"
        fill="#FBBC05"
      />
      <path
        d="M30.57 12.348c4.209 0 7.949 1.451 10.936 4.25l8.182-8.162C44.727 3.824 38.285 1 30.57 1 19.402 1 9.766 7.4 5.065 16.727l9.506 7.358c2.26-6.736 8.571-11.737 16-11.737z"
        fill="#EA4335"
      />
    </svg>
  );
...
export const CloseIcon = ({ size = "24" }: { size?: string }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const BackIcon = ({ size = "14" }: { size?: string }) => {
  return (
    <svg
      width={size}
      height={size}
